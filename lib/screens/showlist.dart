...
import 'package:flutter_notes_notes/screens/update.dart';
                        ...
                        return Padding(
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                                title: InkWell(
                                  child: Text(
                                      this.notes![index].name.toUpperCase()),
                                  onTap: () {
                                    _ackAlert(context, this.notes![index]);
                                  },
                                ),
                                subtitle: InkWell(
                                    child: Text(
                                        this.notes![index].email.toLowerCase()),
                                    onTap: () {
                                      _ackAlert(context, this.notes![index]);
                                    }),
    ...
    return showDialog<ConfirmAction>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('This will delete the note'),
          actions: <Widget>[
            TextButton(
